...
select * from universities where city in ('cambridge','toronto','beijing');
 select * from universities where established_year between 1600 and 1900;
 select * from universities where ranking not between 1 and 4;
